        ...
        >
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-[#5f6f63] text-lg max-w-xl mb-8">
              We’re committed to offering more than just treatment. Our experts
              are here to guide you through every step of your physical
              wellness.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full lg:w-auto ">
            ...
            <ContactCard
              ...
              subtitle="Get a callback in 24h"
            />
            <ContactCard
              icon={<Clock size={22} />}
              label="Working Hours"
