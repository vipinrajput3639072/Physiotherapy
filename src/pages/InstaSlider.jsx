...
const InstaSlider = () => {
  ...
  const instaVideos = [
    {
      id: 1,
      url: "https://www.youtube.com/embed/LOth2cr8aTw",
      title: "Knee Rehab",
    },
    {
      id: 2,
      url: "https://www.youtube.com/embed/9h_bF5c57Ng",
      title: "Spine Care",
    },
    {
      id: 3,
      url: "https://assets.mixkit.co/videos/preview/mixkit-doctor-checking-a-patients-shoulder-41010-large.mp4",
      title: "Shoulder Check",
    },
    {
      id: 4,
      url: "https://assets.mixkit.co/videos/preview/mixkit-physiotherapist-assisting-a-patient-with-a-walker-41005-large.mp4",
      title: "Mobility Aid",
    },
    {
      id: 5,
      url: "https://assets.mixkit.co/videos/preview/mixkit-professional-physiotherapist-working-on-a-patient-41001-large.mp4",
      title: "Manual Therapy",
    },
    {
      id: 6,
      url: "https://assets.mixkit.co/videos/preview/mixkit-woman-doing-stretching-exercises-with-a-physiotherapist-41003-large.mp4",
      title: "Stretching",
    },
  ];
    ...
    <section className="py-24 bg-[#f8fafc] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
        ...
        <p className="text-slate-500 mt-4 max-w-2xl mx-auto text-lg leading-relaxed">
          Experience our advanced physiotherapy techniques through our live
          session reels.
          <span className="block font-medium text-slate-700">
            Tap any video to unmute.
          </span>
        </p>
      </div>
            ...
            return (
              <div
                ...
                className={`relative flex-shrink-0 w-72 h-[500px] md:w-80 md:h-[550px] rounded-[3rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.15)] bg-slate-900 cursor-pointer transition-all duration-700 ${
                  isUnmuted
                    ? "ring-[6px] ring-teal-500/30 scale-[1.03] z-10"
              ...
              >
                ...
                <div className="absolute top-8 right-8 z-30">
                  <div
                    className={`p-3 rounded-full backdrop-blur-xl border border-white/20 transition-all duration-300 ${isUnmuted ? "bg-teal-500 text-white" : "bg-black/20 text-white/70"}`}
                  >
                    {isUnmuted ? (
